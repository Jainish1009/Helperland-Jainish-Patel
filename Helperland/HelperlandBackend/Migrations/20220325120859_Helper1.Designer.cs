...
namespace HelperlandBackend.Migrations
{
    ...
    [Migration("20220325120859_Helper1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelperlandBackend.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("HelperlandBackend.Models.FavoriteAndBlocked", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.Rating", b =>
                {
            ...
            modelBuilder.Entity("HelperlandBackend.Models.ServiceRequest", b =>
                {
                    b.Property<int>("ServiceRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.ServiceRequestAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.ServiceRequestExtra", b =>
                {
            ...
            modelBuilder.Entity("HelperlandBackend.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.UserAddress", b =>
                {
            ...
            modelBuilder.Entity("HelperlandBackend.Models.Zipcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.City", b =>
                {
                    b.HasOne("HelperlandBackend.Models.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.FavoriteAndBlocked", b =>
                {
                    b.HasOne("HelperlandBackend.Models.User", "TargetUser")
                        .WithMany("FavoriteAndBlockedTargetUsers")
                        .HasForeignKey("TargetUserId")
                        .HasConstraintName("FK_FavoriteAndBlocked_User")
                        .IsRequired();

                    b.HasOne("HelperlandBackend.Models.User", "User")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.Rating", b =>
                {
                    b.HasOne("HelperlandBackend.Models.User", "RatingFromNavigation")
                        .WithMany("RatingRatingFromNavigations")
                        .HasForeignKey("RatingFrom")
                        .HasConstraintName("FK_Rating_User")
                        .IsRequired();

                    b.HasOne("HelperlandBackend.Models.User", "RatingToNavigation")
                        .WithMany("RatingRatingToNavigations")
                        .HasForeignKey("RatingTo")
                        .HasConstraintName("FK_Rating_User1")
                        .IsRequired();

                    b.HasOne("HelperlandBackend.Models.ServiceRequest", "ServiceRequest")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.ServiceRequest", b =>
                {
                    b.HasOne("HelperlandBackend.Models.User", "ServiceProvider")
            ...
            modelBuilder.Entity("HelperlandBackend.Models.Zipcode", b =>
                {
                    b.HasOne("HelperlandBackend.Models.City", "City")
                        .WithMany("Zipcodes")
